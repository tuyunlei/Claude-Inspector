...
import { FileTreeNode, ProjectStats } from '../../../types';
...
export const ProjectFilesView: React.FC<ProjectFilesViewProps> = ({ project }) => {
  ...
  return (
    <div className="flex h-full overflow-hidden">
      {/* Sidebar: Tree */}
      <div className="w-80 bg-white dark:bg-slate-900 border-r border-slate-200 dark:border-slate-800 overflow-y-auto flex flex-col transition-colors">
      ...
      <div className="flex-1 overflow-y-auto bg-slate-50 dark:bg-slate-950 p-8 transition-colors">
         {selectedNode && meta ? (
